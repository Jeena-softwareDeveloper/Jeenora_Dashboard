                ...
                <div key={img._id} className="grid grid-cols-12 gap-4 p-4 hover:bg-gray-50 transition-colors items-center">
                  ...
                  <div className="col-span-2 flex items-center justify-center gap-2">
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg text-sm font-medium transition-colors ${img.isActive
                  ...
                  <div key={img._id} className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${img.isActive
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                        <button
                          onClick={() => handleToggleStatus(img)}
                          className={`px-3 py-1 rounded text-xs font-medium transition-colors ${img.isActive
