                ...
                <tbody>
                  {filteredStories.map(story => (
                    <tr key={story._id} className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                      <td className="p-4 text-gray-900 font-medium max-w-xs">
                        <div className="line-clamp-2" title={story.heading}>
                          {story.heading}
                        </div>
                      </td>
                      <td className="p-4">
                      ...
                      <td className="p-4 text-gray-600 text-sm max-w-xs">
                        <div className="line-clamp-2" title={story.description}>
                          {story.description}
                        </div>
                      </td>
                      ...
                      <td className="p-4">
                        <button
                          ...
                          className={`px-3 py-1 rounded-lg text-sm font-medium transition-colors ${story.isActive
                  ...
                  <div key={story._id} className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${story.isActive
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                        <button
                          onClick={() => handleToggleStatus(story)}
                          className={`px-3 py-1 rounded text-xs font-medium transition-colors ${story.isActive
